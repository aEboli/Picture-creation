...
import type { AppSettings, BrandRecord, JobRecord, TemplateRecord } from "@/lib/types";
...
const readTemplatesPageData = cache((): TemplatesPageData => ({
  templates: listTemplatesSnapshot(),
}));
...
export function getTemplatesPageData(): TemplatesPageData {
  return readTemplatesPageData();
}
